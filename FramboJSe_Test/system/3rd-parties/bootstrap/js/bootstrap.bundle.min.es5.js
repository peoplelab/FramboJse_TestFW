  ...
  "use strict";function n(t, e) {
    ...
    _function: while (_again) {
      ...
      if (!t || -1 !== ["HTML", "BODY", "#document"].indexOf(t.nodeName)) return window.document.body;var e = r(t),
          n = e.overflow,
          i = e.overflowX;if (/(auto|scroll)/.test(n + e.overflowY + i)) {
        return t;
      } else {
        _x = o(t);
        _again = true;
    ...
    _function2: while (_again2) {
      ...
      var e = t && t.offsetParent,
          n = e && e.nodeName;if (n && "BODY" !== n && "HTML" !== n) {
        if (-1 !== ["TD", "TABLE"].indexOf(e.nodeName) && "static" === r(e, "position")) {
          _x2 = e;
          _again2 = true;
          e = n = undefined;
          continue _function2;
    ...
    _function4: while (_again4) {
      ...
      if (!(t && t.nodeType && e && e.nodeType)) return window.document.documentElement;var n = t.compareDocumentPosition(e) & Node.DOCUMENT_POSITION_FOLLOWING,
          i = n ? t : e,
          r = n ? e : t,
          o = document.createRange();o.setStart(i, 0), o.setEnd(r, 0);var s = o.commonAncestorContainer;if (t !== s && e !== s || i.contains(r)) return l(s) ? s : a(s);var h = c(t);if (h.host) {
        _x4 = h.host;
        _x5 = e;
        _again4 = true;
        n = i = r = o = s = h = undefined;
        continue _function4;
      } else {
        _x4 = t;
        _x5 = c(e).host;
    ...
    _function5: while (_again5) {
      ...
      _again5 = false;
      var e = t.nodeName;
      if (!(_left = "BODY" !== e && "HTML" !== e)) {
        return _left;
      }

      if (_left = "fixed" === r(t, "position")) {
        return _left;
      }
    ...
    function t(t) {
      ...
      if (window.QUnit) return !1;var t = document.createElement("bootstrap");for (var e in s) if ("undefined" != typeof t.style[e]) return { end: s[e] };return !1;
    }function r(t) {
      var n = this,
    ...
    var t = "carousel",
      ...
      function r(t, n) {
        ...
        return this.each(function () {
          var i = e(this).data(n),
              s = e.extend({}, o, e(this).data());"object" == typeof t && e.extend(s, t);var a = "string" == typeof t ? t : s.slide;if ((i || (i = new r(this, s), e(this).data(n, i)), "number" == typeof t)) i.to(t);else if ("string" == typeof a) {
    ...
    var t = "collapse",
      ...
      function i(t, n) {
        ...
        return this.each(function () {
          var o = e(this),
              s = o.data(n),
              a = e.extend({}, r, o.data(), "object" == typeof t && t);if ((!s && a.toggle && /show|hide/.test(t) && (a.toggle = !1), s || (s = new i(this, a), o.data(n, s)), "string" == typeof t)) {
    ...
    if ("undefined" == typeof _t) throw new Error("Bootstrap dropdown require Popper.js (https://popper.js.org)");var t = "dropdown",
      ...
      function r(t, e) {
        ...
        return this.each(function () {
          var i = e(this).data(n),
              o = "object" == typeof t ? t : null;if ((i || (i = new r(this, o), e(this).data(n, i)), "string" == typeof t)) {
      ...
      function i(t, n) {
        ...
        return this.each(function () {
          var r = e(this).data("bs.modal"),
              o = e.extend({}, i.Default, e(this).data(), "object" == typeof t && t);if ((r || (r = new i(this, o), e(this).data("bs.modal", r)), "string" == typeof t)) {
      ...
      function i(t, e) {
        ...
        return this.each(function () {
          var n = e(this).data("bs.tooltip"),
              r = "object" == typeof t && t;if ((n || !/dispose|hide/.test(t)) && (n || (n = new i(this, r), e(this).data("bs.tooltip", n)), "string" == typeof t)) {
      ...
      function f() {
        ...
        return this.each(function () {
          var n = e(this).data("bs.popover"),
              i = "object" == typeof t ? t : null;if ((n || !/destroy|hide/.test(t)) && (n || (n = new f(this, i), e(this).data("bs.popover", n)), "string" == typeof t)) {
            if ("undefined" == typeof n[t]) throw new Error('No method named "' + t + '"');n[t]();
          }
        });
    ...
    var t = "scrollspy",
      ...
      function n(t, n) {
        ...
        var t = this._getScrollTop() + this._config.offset,
          ...
          if (this._activeTarget && t < this._offsets[0] && this._offsets[0] > 0) return this._activeTarget = null, void this._clear();for (var r = this._offsets.length; r--;) this._activeTarget !== this._targets[r] && t >= this._offsets[r] && ("undefined" == typeof this._offsets[r + 1] || t < this._offsets[r + 1]) && this._activate(this._targets[r]);
        }
        ...
        return this.each(function () {
          var i = e(this).data("bs.scrollspy"),
              r = "object" == typeof t && t;if ((i || (i = new n(this, r), e(this).data("bs.scrollspy", i)), "string" == typeof t)) {
            if ("undefined" == typeof i[t]) throw new Error('No method named "' + t + '"');i[t]();
          }
        });
