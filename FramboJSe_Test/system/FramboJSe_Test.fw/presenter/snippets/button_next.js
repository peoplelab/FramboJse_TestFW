// button_next.js -> "button_next" snippet management file
// target:  <snp_button_next />
// funct.:  Inserimento del pulsante "Prossimo" per la navigazione "step +1"
// output:  button
define ([], function() {

	var _ITEMNAME = 'button_next';												// Item's name
	...
	function buildHtml(tagPars, pbAttrs) {
		...
		var myHtml = '';
		var icon = 'fa fa-play-circle';											// font awesome icon

		// HTML definition
		myHtml += '<button disabled="disabled" class="' + _ITEMNAME + pbAttrs[0] + ' btn btnMain" href="#next" ' + pbAttrs[1] + '>';
