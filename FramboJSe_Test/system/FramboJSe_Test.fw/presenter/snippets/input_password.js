// input_password.js -> "input_password" snippet management file
// target:  <snp_input_password/>
// funct.:  
// output:  campo input per password
define (['./input_kernel.js'], function(kernel) {

    var _ITEMNAME = 'input_password';                        // Item's name
