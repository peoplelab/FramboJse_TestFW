// constants.model.js : constants module
define([], function () {
    ...
    function getCurrency(params) {
        return currencies[params.currency];
    }

    function getSymbol(params) {
        if (params.symbol !== undefined) {
            if (symbols[params.symbol]) {
                return symbols[params.symbol];
            }
            if (currencies[params.symbol] && currencies[params.symbol].symbol) {
                return currencies[params.symbol].symbol;
            }
        }
        return;
    }
